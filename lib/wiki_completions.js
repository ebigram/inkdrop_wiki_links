"use strict"; // This file is required by the index.html file and will
...
exports.option = exports.strategy = exports.gatherCandidates = void 0; // How to construct the editor object depends on the actual editor class.
...
var db = inkdrop && ((_b = (_a = inkdrop === null || inkdrop === void 0 ? void 0 : inkdrop.main) === null || _a === void 0 ? void 0 : _a.dataStore) === null || _b === void 0 ? void 0 : _b.getLocalDB()); //the actual result of search
//@ts-ignore

var cursor = inkdrop && ((_c = inkdrop === null || inkdrop === void 0 ? void 0 : inkdrop.codeMirror) === null || _c === void 0 ? void 0 : _c.getCursor()); //experimental
...
var gatherCandidates = function (term) {
