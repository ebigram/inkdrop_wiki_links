...
module.exports = {
  ...
  handleEditorDidLoad() {
    // const { cm } = editor;
    const activeEditor = inkdrop.getActiveEditorOrThrowError(); // cm.foobar = 1;
    // otherThing.foobar = 2;
    // debugger;
    ...
    const textcompleteEditor = new _codemirror.CodeMirrorEditor(activeEditor.cm); // const textcompleteEditor = new CodeMirrorEditor(activeEditor.cm);

    const textcomplete = new _core.Textcomplete(textcompleteEditor, [_wiki_completions.strategy], _wiki_completions.option);
  }
